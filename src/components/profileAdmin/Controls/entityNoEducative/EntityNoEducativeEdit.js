...
import { fetchCountries, fetchDepartamentos, fetchEntityNoEducativeEdit, fetchEntityNoEducativeOne, fetchMunicipalities } from '../../../../service/service';

export const EntityNoEducativeEdit = () => {
	...
	const getEntity = async () => {
		try {
			getAllEntity = await fetchEntityNoEducativeOne(entityId);
	...
	const handleEditEntityNoEducative = async (e) => {
		...
		// console.log(entity);
		try {
			await fetchEntityNoEducativeEdit(allEntity.id,entity);
