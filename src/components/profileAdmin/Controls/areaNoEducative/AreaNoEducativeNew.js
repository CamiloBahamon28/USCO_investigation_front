...
export const AreaNoEducativeNew = () => {

    const nameAreaRef = useRef();
    const enteRef = useRef();
    ...
    const handleNewArea = (e) => {
        ...
        const areaNoEducative = {
            nameArea: nameAreaRef.current.value,
            entityNoEducative: enteRef.current.value,
            municipality:  cityRef.current.value,
