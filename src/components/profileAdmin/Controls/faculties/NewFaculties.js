...
import {  fetchCountries, fetchDepartamentos, fetchEntityEducative, fetchFacultyNew, fetchMunicipalities } from '../../../../service/service';

export const NewFaculties = () => {
								...
								<div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
									...
									<select
										...
										>
											...
											{entitiesEducative.map((entityNo) => (
