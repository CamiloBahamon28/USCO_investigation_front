...
export const NavbarAdmin = () => {
    return (
        <div>
            <div>
                <nav className="flex flex-col bg-indigo-600 w-64 h-screen px-4 tex-gray-900 border border-indigo-600">
                    <div className="flex flex-wrap mt-8">
                        ...
                        <div className="w-1/2">
                            ...
                            <button
                                className="bg-emerald-500 text-white px-4 py-2 rounded-md border border-blue-500 hover:bg-white hover:text-green-500">
                                Premium
                            </button>
                        </div>
                    </div>
